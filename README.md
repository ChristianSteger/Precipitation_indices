...
(at least for the percentiles in the range of 90% - 99%). The differences in the percentiles are caused by the different methods applied to compute them (Python: consider all individual values, CDO: bin data in 1001 bins).
